...
// ── Brand domain list ─────────────────────────────────────────────────────────
// Covers the most commonly impersonated brands worldwide + Nigeria-specific
const BRAND_DOMAINS: Array<{ brand: string; registrable: string[] }> = [
  ...
  { brand: 'Facebook',        registrable: ['facebook.com', 'fb.com'] },
  { brand: 'Instagram',       registrable: ['instagram.com'] },
  { brand: 'LinkedIn',        registrable: ['linkedin.com'] },
  { brand: 'Twitter/X',       registrable: ['twitter.com', 'x.com'] },
  ...
  { brand: 'MTN',             registrable: ['mtnonline.com'] },
